...
# Autogenerated by clearance gem, just removed :edit, update
  ...
  #resources :passwords, controller: "passwords", only: [:edit, :create, :new]
  ...
  resources :users, controller: "users", only: [:create, :show, :destroy, :index, :update] do
    #resource :password,
      ...
      #This used to have :edit (:edit needed for emails)
  ...
  #get "/edit_password" => "passwords#edit", as: "edit"
  #get "/update_password/:email" => "users#update", :constraints => { :email => /.+@.+\..*/ }, as: "update_user_password"
  #get "/users/:id/password/edit:token" => "passwords#edit", as: "password_edit"
