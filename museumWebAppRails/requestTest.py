import requests
r = requests.post('http://localhost:3000/api/v1/readings', headers={'Authorization' : 'rasPiAuth..0246'}, data = {'node_id' : '5', 'pin' : '8', 'temp': '82', 'hum' : '50', 'timeStamp' : '2017-02-15 00:46:34.521341'})
