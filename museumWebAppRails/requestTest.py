import requests
r = requests.post('http://localhost:3000/api/v1/readings', headers={'Authorization' : 'rasPiAuth..0246'}, data = {"temp" : '58.82', "hum" : '50.50', "volt" : 3271,  "node_id" : 8, "timeStamp"  : "2017-03-06 14:44:13.193749-08:00"}
)
